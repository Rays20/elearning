...
var eduMin = function(){
	...
	var studentsPerYearChart = function(){
		new Morris.Bar({
			element: 'students-per-year',
			data: [
				{ year: '1st Year', value: 100 },
				{ year: '2nd Year', value: 150 },
				{ year: '3rd Year', value: 50 }
	...
	var mostVisitedLanguagesChart = function(){
		new Morris.Bar({
			element: 'most-visited-languages',
			data: [
				{ language: 'JS', visits: 500 },
				{ language: 'PY', visits: 400 },
				{ language: 'Java', visits: 350 },
				{ language: 'C++', visits: 300 },
				{ language: 'PHP', visits: 250 }
				// Add more data points as needed
			],
			xkey: 'language',
			ykeys: ['visits'],
	...
	/* Function ============ */
		return {
			...
			load:function(){
				...
				peityLine2();
				peityLine3();
				studentsPerYearChart(); // Add this line
				mostVisitedLanguagesChart(); // Add this line
